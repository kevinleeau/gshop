 ...
 <section class="msite">
        ...
        <header class="header">
          ...
          <span class="header_title">
            <span class="header_title_text ellipsis">aaa</span>
          </span>
                ...
                <a>
                  ...
                  <div class="shop_right">
                    <section class="shop_detail_header">
                      <h4 class="shop_title ellipsis">good</h4>
                      <ul class="shop_detail_ul">
                        <li class="supports">a</li>
                        <li class="supports">b</li>
                        <li class="supports">c</li>
                      </ul>
                    </section>
                    <section class="shop_rating_order">
                      ...
                      <section class="shop_rating_order_right">
                        <span class="delivery_style delivery_right">delivery</span>
                      </section>
                    </section>
