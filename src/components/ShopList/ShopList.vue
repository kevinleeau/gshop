                  ...
                  <div class="shop_right">
                    ...
                    <section class="shop_rating_order">
                      <section class="shop_rating_order_left">
                        <!-- 在父组件里定义子组件容器，并把自己的参数传递出去 -->
                        <Star :score="item.rating" :size="24"/>
                        <div class="rating_section">{{item.rating}}
                        </div>
                        <div class="order_section">
                          Order history: {{item.recent_order_num}}
                        </div>
                      </section>
                    ...
                    <section class="shop_distance">
                      <p class="shop_delivery_msg">
                        <span>Minimum spend: ${{item.float_minimum_order_amount}}</span>
                        <span class="segmentation">/</span>
                        <span>Delivery cost: ${{item.float_delivery_fee}}</span>
                      </p>
                    </section>
                  </div>
                </a>
...
export default {
  ...
  data () {
    return {
      // note: serve imagebaseURL path doesnot work
      imageBaseURL: 'http://cangdu.org:8001/img/'
    }
  },
  computed: {
    ...mapState(['shops'])
